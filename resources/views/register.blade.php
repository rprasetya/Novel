...
@section('content')
    ...
    <div class="formLoginCont">
        ...
        <form class="form" action="/register" method="POST">
            ...
            <input class="input" id="fullName" name="fullName" placeholder="@error('fullName') {{ $message }} @else Full Name @enderror" type="text" required="" value="{{ old("fullName") }}" autofocus>
